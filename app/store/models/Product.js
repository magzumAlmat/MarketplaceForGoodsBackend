...
// Product.belongsToMany(require('./Category'), { through: 'ProductCategory', as: 'Categories' });
// Product.hasMany(require('./ProductImage'), { as: 'ProductImages', foreignKey: 'productId' });
